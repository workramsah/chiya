...
export default function Container(){
    return(
        <>
        <div className=" h-[650px] w-full flex items-center px-2">
        <div>
            ...
            <h1 className="text-[20px] mt-6">Carefully curated for bi-monthly release.</h1>
        </div>
        <img className="w-[600px] h-[600px]" src="cup.png"></img>
