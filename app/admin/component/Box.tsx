        ...
        <>
            <div className="bg-amber-300 flex-col justify-evenly w-full space-y-8 px-4">
                ...
                <div className="flex w-full justify-between">
                    <h1 className="font-medium">ITEMS {props.items}</h1>
                    <h1 className="font-medium">${props.subtotal.toFixed(2)}</h1>
                </div>
                <div className="flex w-full justify-between">
                    <h1 className="font-medium">Shipping fee</h1>
                    <h1 className="font-medium">${props.shipping.toFixed(2)}</h1>
                </div>
                <div className="flex border-b w-full justify-between">
                    <h1 className="font-medium">Tax (2%)</h1>
                    <h1 className="font-medium">${props.tax.toFixed(2)}</h1>
                </div>
                <div className="font-medium w-full flex justify-between">
                    <h1 className="font-medium">Total</h1>
                    <h1 className="font-medium">${props.total.toFixed(2)}</h1>
                </div>
